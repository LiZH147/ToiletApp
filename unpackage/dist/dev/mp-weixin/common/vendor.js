...
const pages = [
  ...
  {
    path: "pages/mapPages/index",
    style: {
      navigationBarTitleText: ""
    }
  },
  {
    path: "pages/showTolietDetail/showTolietDetail",
    style: {
      navigationBarTitleText: ""
    }
  }
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I('{"address":["127.0.0.1","10.125.248.139","192.168.60.1","192.168.220.1"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","F:/HBuilderX.3.6.4.20220922/HBuilderX/plugins/unicloud/**/*.js"]}'), T = I('[{"provider":"alipay","spaceName":"toilet-app","spaceId":"env-00jxhaxsxwpv","spaceAppId":"2021004160669431","accessKey":"EqMZzzl3MXpPa2AJ","secretKey":"F9Gq2JZqtWZQN7jv"}]') || [];
let O = "";
try {
  O = "__UNI__F87E279";
} catch (e2) {
